...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Bogdan M.
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Frontend Web Developer / IT Technician</h3>

        <p className="home__description">I'm creative Frontend Web Developer based in Serbia, and I'm very passionate and dedicated to my work.</p>
